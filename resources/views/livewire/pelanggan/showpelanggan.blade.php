        ...
        <div class="space-y-4">
            ...
            <div class="grid grid-cols-12 gap-4">
                <div class="col-span-4">
                    <x-mary-input label="Jenis Pelanggan" wire:model="Jenis_Plg" readonly class=""/>
                </div>
                <div class="col-span-4">
                    <x-mary-input label="Email" wire:model="Email" readonly class=""/>
                </div>
                <div class="col-span-4">
                    <x-mary-input label="Telepon" wire:model="Telepon" readonly class=""/>
                </div>
            </div>
            <div class="grid grid-cols-12 gap-4">
