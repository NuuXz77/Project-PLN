        ...
        <div class="space-y-4">
            <div class="grid grid-cols-12 gap-4">
                <div class="col-span-6">
                    <x-mary-input label="No Pemakaian" wire:model="No_Pemakaian" readonly class=""/>
                </div>
                <div class="col-span-6">
            ...
            <div class="grid grid-cols-12 gap-4">
                <div class="col-span-6">
                    <x-mary-input label="Nama Pelanggan" wire:model="Nama" readonly class=""/>
                </div>
                <div class="col-span-6">
                    <x-mary-input label="Tanggal Catat" wire:model="TanggalCatat" readonly class=""/>
                </div>
            </div>
            <div class="grid grid-cols-12 gap-4">
                <div class="col-span-4">
                    <x-mary-input label="Meter Awal" wire:model="MeterAwal" readonly class=""/>
                </div>
                <div class="col-span-4">
                    <x-mary-input label="Meter Akhir" wire:model="MeterAkhir" readonly class=""/>
                </div>
                <div class="col-span-4">
                    <x-mary-input label="Jumlah Pakai" wire:model="JumlahPakai" readonly class=""/>
                </div>
            </div>
            <div class="grid grid-cols-12 gap-4">
                <div class="col-span-6">
                    <x-mary-input label="Biaya Beban" wire:model="BiayaBebanPemakaian" readonly class=""/>
                </div>
                <div class="col-span-6">
                    <x-mary-input label="Biaya Pemakaian" wire:model="BiayaPemakaian" readonly class=""/>
                </div>
            </div>
            <div class="grid grid-cols-12 gap-4">
                <div class="col-span-12">
                    <x-mary-input label="Status Pembayaran" wire:model="StatusPembayaran" readonly class=""/>
                </div>
            </div>
        </div>
        <x-slot:actions>
